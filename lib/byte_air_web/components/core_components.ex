defmodule ByteAirWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ByteAirWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ByteAirWeb.Gettext, "errors", msg, opts)
    end
  end
