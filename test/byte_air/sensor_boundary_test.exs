defmodule ByteAir.SensorBoundaryTest do
  ...
  describe "bme688readings" do
    ...
    test "create_bme688_reading/1 with valid data creates a bme688_reading" do
      valid_attrs = %{gas: 120.5, humidity: 120.5, name: "some name", pressure: 120.5, temperature: 120.5}

      assert {:ok, %BME688Reading{} = bme688_reading} = SensorBoundary.create_bme688_reading(valid_attrs)
    ...
    test "update_bme688_reading/2 with valid data updates the bme688_reading" do
      bme688_reading = bme688_reading_fixture()
      update_attrs = %{gas: 456.7, humidity: 456.7, name: "some updated name", pressure: 456.7, temperature: 456.7}

      assert {:ok, %BME688Reading{} = bme688_reading} = SensorBoundary.update_bme688_reading(bme688_reading, update_attrs)
    ...
    test "update_bme688_reading/2 with invalid data returns error changeset" do
      bme688_reading = bme688_reading_fixture()
      assert {:error, %Ecto.Changeset{}} = SensorBoundary.update_bme688_reading(bme688_reading, @invalid_attrs)
    ...
    test "delete_bme688_reading/1 deletes the bme688_reading" do
      ...
      assert_raise Ecto.NoResultsError, fn -> SensorBoundary.get_bme688_reading!(bme688_reading.id) end
    end
  ...
  describe "pms5003readings" do
    ...
    test "create_pms5003_reading/1 with valid data creates a pms5003_reading" do
      ...
      assert {:ok, %PMS5003Reading{} = pms5003_reading} = SensorBoundary.create_pms5003_reading(valid_attrs)
    ...
    test "update_pms5003_reading/2 with valid data updates the pms5003_reading" do
      ...
      assert {:ok, %PMS5003Reading{} = pms5003_reading} = SensorBoundary.update_pms5003_reading(pms5003_reading, update_attrs)
    ...
    test "update_pms5003_reading/2 with invalid data returns error changeset" do
      pms5003_reading = pms5003_reading_fixture()
      assert {:error, %Ecto.Changeset{}} = SensorBoundary.update_pms5003_reading(pms5003_reading, @invalid_attrs)
    ...
    test "delete_pms5003_reading/1 deletes the pms5003_reading" do
      ...
      assert_raise Ecto.NoResultsError, fn -> SensorBoundary.get_pms5003_reading!(pms5003_reading.id) end
    end
